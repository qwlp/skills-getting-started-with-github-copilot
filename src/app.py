...
activities = {
    ...
    "Track and Field": {
        "description": "Build speed, strength, and endurance through track and field events",
    ...
    "Debate Team": {
        "description": "Research current topics and develop persuasive speaking skills",
